                        ...
                        <div class="card-body">
                            <form method="post" id="edit_patient" action="" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    value="<?php if(!empty($patient->getEmri())){ echo $patient->getEmri();} ?>"/>
                                </div>
                                <div class="form-group">
                                    ...
                                    value="<?php if(!empty($patient->getMbiemri())){ echo $patient->getMbiemri();} ?>" />
                                </div>
                                <div class="form-group">
                                    ...
                                    value="<?php if(!empty($patient->getNr_telefoni())){ echo $patient->getNr_telefoni();} ?>"/>
                                </div>
                                <div class="form-group">
                                    <label class="small mb-1" for="email">Email :</label>
                                    <input class="form-control py-4" name="email" id="email" type="text" placeholder="Email" 
                                    value="<?php if(!empty($patient->getEmail())){ echo $patient->getEmail();} ?>"/>
                                </div>
                                <div class="form-group">
                                    ...
                                    value="<?php if(!empty($patient->getFjalekalimi())){ echo $patient->getFjalekalimi();} ?>"/>
                                </div>
