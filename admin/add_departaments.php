        ...
        <div class="container-fluid">
            ...
            <div class="row justify-content-center">
                ...
                if (isset($_POST['add_departament'])) {
                    ...
                    $departament->setDepartamenti_Emri($_POST['demri']);
                ...
                <div class="col-lg-9">
                    <div class="card shadow-lg border-0 rounded-lg mt-5">
                        <div class="card-header">
                            <h3 class="text-center font-weight-light my-2">Create Departament</h3>
                        </div>
                        ...
                        <div class="card-body">
                            <form method="post" id="add_departament" action="" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label class="small mb-1" for="demri">Emri :</label>
                                    <input class="form-control py-4" name="demri" id="demri" type="text" placeholder="Emri">
                                </div>
                                ...
                                <input class="btn btn-primary" id="login" value="Create Departament" type="submit" name="add_departament" />
                            </form>
                        </div>
